...
class MockData {
  ...
  static final Vehicle xb7 = Vehicle(
    ...
    nextServiceKm: 10000,
    modelAsset: 'assets/models/bmw_xb7.glb',
    paintMaterialName: 'bmwx7_body',
    latitude: 37.9601,
    longitude: 58.3908,
    address: 'Bitarap Türkmenistan şaýoly, Aşgabat',
  );

  static final Vehicle m340i = Vehicle(
    model: 'BMW M340i xDrive',
    vin: 'WBA5R7C09L7D14926',
    mileageKm: 62300,
    plate: '01 AC 1198',
    fuelPercent: 0.54,
    nextServiceDate: DateTime.now().add(const Duration(days: 5)),
    nextServiceKm: 65000,
    modelAsset: 'assets/models/bmw_m340i.glb',
    paintMaterialName: 'Kuzov_Main_color',
    latitude: 37.9452,
    longitude: 58.3701,
  ...
  static final Vehicle m4 = Vehicle(
    model: 'BMW M4 CSL',
    vin: 'WBS31AZ00PCM56781',
    mileageKm: 9800,
    plate: '01 BB 9042',
    fuelPercent: 0.88,
    nextServiceDate: DateTime.now().add(const Duration(days: 60)),
    nextServiceKm: 15000,
    modelAsset: 'assets/models/bmw_m4.glb',
    paintMaterialName: 'M4xNME_Paint',
    latitude: 37.9552,
    longitude: 58.3654,
    address: 'Andalyp köçesi, Aşgabat',
  );

  static final Vehicle x6m = Vehicle(
    model: 'BMW X6 M Competition',
    vin: '5YMCY0C08P9J49371',
    mileageKm: 29650,
    plate: '01 BC 1275',
    fuelPercent: 0.71,
    nextServiceDate: DateTime.now().add(const Duration(days: 35)),
    nextServiceKm: 40000,
    modelAsset: 'assets/models/bmw_x6m.glb',
    paintMaterialName: 'body',
    latitude: 37.9418,
    longitude: 58.3799,
  ...
  static final List<NewCarListing> newCarListings = [
    NewCarListing(
      ...
      modelAsset: 'assets/models/bmw_m4.glb',
      paintMaterialName: 'M4xNME_Paint',
      engineTk: '3.0L S58 TwinPower Turbo',
      engineEn: '3.0L S58 TwinPower Turbo',
      engineRu: '3.0L S58 TwinPower Turbo',
      fuelConsumption: 9.6,
      bodyType: 'coupe',
      ...
      trims: [
        TrimLevel(
          ...
          nameRu: 'Competition',
          priceDelta: 0,
          featuresTk: ['510 at güýji', 'M karbon oturgyçlar'],
          featuresEn: ['510 hp', 'M carbon bucket seats'],
          featuresRu: ['510 л.с.', 'Карбоновые ковши M'],
        ),
        TrimLevel(
          nameTk: 'CSL',
          nameEn: 'CSL',
          nameRu: 'CSL',
          priceDelta: 25000,
          featuresTk: ['550 at güýji', '100 kg ýeňil', 'Track paket'],
          featuresEn: ['550 hp', '100 kg lighter', 'Track package'],
          featuresRu: ['550 л.с.', 'На 100 кг легче', 'Трек-пакет'],
        ),
      ],
    ),
    NewCarListing(
      id: 'bmw_xb7',
      nameTk: 'BMW Alpina XB7',
      nameEn: 'BMW Alpina XB7',
      nameRu: 'BMW Alpina XB7',
      basePrice: 145000,
      modelAsset: 'assets/models/bmw_xb7.glb',
      paintMaterialName: 'bmwx7_body',
      engineTk: '4.4L V8 BiTurbo',
      engineEn: '4.4L V8 BiTurbo',
      engineRu: '4.4L V8 BiTurbo',
      ...
      trims: [
        TrimLevel(
          ...
          nameRu: 'Standard',
          priceDelta: 0,
          featuresTk: ['630 at güýji', '7 orunlyk salon', '23" Alpina tigirler'],
          featuresEn: ['630 hp', '7-seat cabin', '23" Alpina wheels'],
          featuresRu: ['630 л.с.', 'Салон на 7 мест', 'Диски Alpina 23"'],
        ),
        TrimLevel(
          nameTk: 'Exclusive',
          nameEn: 'Exclusive',
          nameRu: 'Exclusive',
          priceDelta: 18000,
          featuresTk: ['Lavalina deri', 'Bowers & Wilkins ses', 'Sky Lounge üçek'],
          featuresEn: ['Lavalina leather', 'Bowers & Wilkins sound', 'Sky Lounge roof'],
          featuresRu: ['Кожа Lavalina', 'Аудио Bowers & Wilkins', 'Крыша Sky Lounge'],
        ),
      ],
    ),
    NewCarListing(
      id: 'bmw_x6m',
      nameTk: 'BMW X6 M Competition',
      nameEn: 'BMW X6 M Competition',
      nameRu: 'BMW X6 M Competition',
      basePrice: 125000,
      modelAsset: 'assets/models/bmw_x6m.glb',
      paintMaterialName: 'body',
      ...
      trims: [
        TrimLevel(
          ...
          nameRu: 'Competition',
          priceDelta: 0,
          featuresTk: ['625 at güýji', 'M Sport diferensial'],
          featuresEn: ['625 hp', 'M Sport differential'],
          featuresRu: ['625 л.с.', 'Спортивный дифференциал M'],
        ),
        TrimLevel(
          nameTk: 'M Carbon',
          nameEn: 'M Carbon',
          nameRu: 'M Carbon',
          priceDelta: 12000,
          featuresTk: ['Karbon bezeg toplumy', 'M karbon tormozlar'],
          featuresEn: ['Carbon exterior package', 'M carbon ceramic brakes'],
          featuresRu: ['Карбоновый пакет', 'Карбон-керамические тормоза M'],
        ),
      ],
    ),
  ];
